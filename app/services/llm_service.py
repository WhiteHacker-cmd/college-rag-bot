...
For questions about images or visual elements, you can mention relevant images that have been provided
to you in the context, describing what they show if appropriate.
"""
    ...
    def format_context(self, documents: List[str], metadata: List[Dict[str, Any]]) -> str:
        ...
        for i, (doc, meta) in enumerate(zip(documents, metadata)):
            ...
            context_part = f"[Document {i+1}] {title} (Relevance: {similarity:.2f})\n{doc}\nSource: {source_name}\n"
